/**
 * @generated SignedSource<<8622b10829219a50bfdd023822f1a203>>
...
export type useUpdatePriceListItemMutation$variables = {
  input: UpdatePriceListItemInput;
  item_id: string;
};
export type useUpdatePriceListItemMutation$data = {
...
export type useUpdatePriceListItemMutation = {
  response: useUpdatePriceListItemMutation$data;
  variables: useUpdatePriceListItemMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "useUpdatePriceListItemMutation",
    "selections": [
      {
        "alias": null,
        "args": (v2/*: any*/),
