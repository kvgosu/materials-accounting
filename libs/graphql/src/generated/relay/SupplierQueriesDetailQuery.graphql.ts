/**
 * @generated SignedSource<<e7c18905193492adfd41fe65a753905e>>
...
export type SupplierQueriesDetailQuery$variables = {
  id: string;
};
export type SupplierQueriesDetailQuery$data = {
  readonly supplier: {
...
export type SupplierQueriesDetailQuery = {
  response: SupplierQueriesDetailQuery$data;
  variables: SupplierQueriesDetailQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "SupplierQueriesDetailQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
